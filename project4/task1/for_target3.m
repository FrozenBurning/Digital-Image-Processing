...
target_img = imread('./images/targetImage3.jpg');
mask = imread('./images/mask3.jpg');

%% Image Pre Proc
[h2,w2,c] = size(target_img);
p3 = [350 119;567 94;394 647;600 540];
src_img = src_img(:,460:1460,:);%img crop
src_img = imresize(src_img,[h2,w2]);

%% Stylization
src_img = painting_trans(src_img);
...
%% TPS
img_ref_tps = morph_tps_wrapper(src_img,target_img,p0,p3,1,0);
